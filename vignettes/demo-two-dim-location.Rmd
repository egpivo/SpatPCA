---
title: "[Demo] Capture Dominant Spatial Patten with Two-Dimensional Locations"
output:
    rmarkdown::html_vignette:
    fig_width: 7
    fig_height: 7
vignette: >
  %\VignetteIndexEntry{Demo2D}
...
base_theme <- theme_minimal(base_size = 8, base_family = "Times") +
...
data.frame(
  ...
  scale_fill_gradientn(colours = coltab) +
  base_theme +
