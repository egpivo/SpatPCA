---
title: "[Demo] Capture Dominant Spatial Patten with One-Dimensional Locations"
output:
...
### Animate realizations
- Note: it is hard to see a crystal clear spatial pattern via the simluated sample.
```{r, animation.hook="gifski"}
for (i in 1:100) {
  plot(x = position, y = realizations[i, ], ylim = c(-10, 10), ylab = "realization")
}
...
- Note: **SpatPCA** outperforms to PCA visually when the signal-to-noise ratio is quite lower.
