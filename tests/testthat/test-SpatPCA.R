...
test_that("Selected tuning parameters", {
  ...
  expect_lte(abs(cv_1D_fixed_K_multiple_tau2$selected_tau1 - 0.002154435),
             tol)
  ...
  expect_equal(cv_1D_fixed_K_fixed_tau1_fixed_tau2_multiple_gamma$selected_gamma,
               0)
  ...
  expect_lte(sum(estimated_signle_eigenvalue_medium_gamma) - 0.1066821,
             tol)
})
